...
if($action==1){
	...
	$sql = "select id from web_world where Agname='$username' and passwd = '$password'";
	...
	if($cou==0){
		...
		echo "<script>alert('已成功设置安全代码~~请回重新');self.location='/index.php';</script>";
	exit;
}
...
<table width="450" border="0" align="center" cellpadding="1" cellspacing="1" class="pwd_side">
	...
	<tr>
		<td colspan="2" class="pwd_txt">
			请使用阁下容易记得的名字或代号设定<font class="red_txt">「安全代码」</font>以供使用。
		</td>
	</tr>
	<tr>
		<td colspan="2" class="pwd_txt">
