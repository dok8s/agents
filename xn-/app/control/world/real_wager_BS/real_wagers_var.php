...
case "HOU":
	...
	$sql1 = "select mid,concat(M_Date,'<br>',M_Time,if(m_type=0,'','<br><font style=background-color=red>走地</font>')) as pdate,$mb_team as MB_Team,$tg_team as TG_Team,m_letb as M_LetB_en,m_league as league,MB_Win,TG_Win,M_Flat,MB_Dime_Rate,TG_Dime_Rate,if(m_dime='','',concat('o',m_dime)) as MB_Dime_en,MB_LetB_Rate,TG_LetB_Rate,MB_MID,TG_MID,ShowType,M_Type,R_Show from baseball where r_show=2 and mid%2=0 and `m_Date` ='$mDate' and `m_start` > now( ) ".$sleague."  order by display,mid limit $offset,40";
...
case "F":
	...
	break;
case "P":
	$sql1 = "select MID,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,m_league as M_Sleague,MB_MID,TG_MID,ShowType from baseball where `m_start` > now( ) AND `m_Date` ='$mDate'".$league." and r_show=3 order by m_start,mid";
	//$sql1 = "select mid,concat(M_Date,'<br>',M_Time,if(m_type=0,'','<br><font style=background-color=red>走地</font>')) as pdate,$mb_team as MB_Team,$tg_team as TG_Team,m_letb as M_LetB_en,m_league as league,MB_Win,TG_Win,M_Flat,MB_Dime_Rate,TG_Dime_Rate,if(m_dime='','',concat('o',m_dime)) as MB_Dime_en,MB_LetB_Rate,TG_LetB_Rate,MB_MID,TG_MID,ShowType,M_Type,R_Show from baseball where r_show=3 and `m_Date` ='$mDate' and `m_start` > now( ) ".$sleague."  order by display,mid limit $offset,40";
