...
if($action==1){
	...
	if($cou==0){
		...
		echo "<script>alert('已成功修改登录帐号~~请回重新');self.location='/index.php';</script>";
	}else{
...
<table width="450" border="0" align="center" cellpadding="1" cellspacing="1" class="pwd_side">
	...
	<tr>
		<td colspan="2" class="pwd_txt">
			请使用阁下容易记得的名字或代号设定<font class="red_txt">「登录帐号」</font>以供使用。
		</td>
	</tr>
	<tr>
		<td colspan="2" class="pwd_txt">
...
<table align="center">
	<tr >
		<td class="white">
			<ul><li>如阁下的「登录帐号」设置完成后<font class="red_txt">须以「登录帐号」代理端，</font><BR>原「代理商帐号」只供识别身份使用，不可。</li></ul>
		</td>
	</tr>
</table>
