  ...
  with(obj_table)
  {
   ...
   for(i=0; i<data_amount; i++)
   {
    ...
    with(nowTR)
    {
     ...
     //����/�`��
     wargeEO = eval(GameData[i][33] + '+' + GameData[i][35]); //�����`��[�`
     ...
     //�L��/�`��
     warge_RP = eval(GameData[i][45] + '+' + GameData[i][46] + '+' + GameData[i][47]); //�D�ȶ��`��[�`
...
<!--
 ...
 var gamount = 0; //�ثe����ɵ{��
 var GameTN = new Array(1024); //�̦h�]�w���1024���ɵ{
 for(var i=0; i<1024; i++){
 	GameTN[i] = new Array(37); //���U�ɵ{�ŧi 37 �����
 }
// -->
</SCRIPT>
</head>
