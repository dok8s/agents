...
<td width = "200"> Trích xuất / ghi chú </ td>
<td width = "200"> Đĩa / ghi chú </ td>
...
     <td width = "28"> Sự kiện </ td>
     <td width = "200"> Nhóm </ td>
     <td width = "195"> Chuyển đổi / ghi chú </ td>
...
               </select>
            ...
            <td id="dt_now"> -- <?=$rel_dtnow?>:</td>
						<td>&nbsp;--&nbsp;<a href="#" onClick="chg_page('all');" onMouseOver="window.status='单式全部'; return true;" onMouseOut="window.status='';return true;" style="background-color:<?=$back_all?>">Kiểu đơn</a>
							&nbsp;<a href="#" onClick="chg_page('ou');" onMouseOver="window.status='单式'; return true;" onMouseOut="window.status='';return true;" style="background-color:<?=$back_ou?>">Phong cách duy nhất</a>
							&nbsp;<a href="#" onClick="chg_page('r4');" onMouseOver="window.status='单节'; return true;" onMouseOut="window.status='';return true;" style="background-color:<?=$back_rq4?>">Một phần</a>
							&nbsp;<a href="#" onClick="chg_page('re');" onMouseOver="window.status='滚球'; return true;" onMouseOut="window.status='';return true;" style="background-color:<?=$back_re?>">Cán bóng</a>
							&nbsp;<a href="#" onClick="chg_page('par');" onMouseOver="window.status='过关'; return true;" onMouseOut="window.status='';return true;"style="background-color:<?=$back_par?>">Giải phóng mặt bằng</a>
							&nbsp;<a href="#" onClick="chg_page('p');" onMouseOver="window.status='已开赛'; return true;" onMouseOut="window.status='';return true;"style="background-color:<?=$back_p?>">Đã bắt đầu</a>
						</td>
          </tr>
        </table>
      </td>
