...
function onclickDown(){
	var uid="<?=$uid?>";
	var langx="{LANGX}";
  	window.open("getVagentsheader.php?uid="+uid+"&langx="+langx,"showVagents","width=1024,height=768,toolbar=no,scrollbars=yes,resizable=no,personalbar=no");	
  	//parent.window.location.href = "./getVagentsheader.php?uid="+uid+"&langx="+langx;
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<tr>
			...
			<a onClick="go_web(0,0,'/xn/app/control/agents/real_wager/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Bóng đá</a>
			<a onClick="go_web(0,1,'/xn/app/control/agents/real_wager_BK/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Bóng rổ / Họp</a>
			<a onClick="go_web(0,1,'/xn/app/control/agents/real_wager_TN/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Quần vợt</a>
			<a onClick="go_web(0,1,'/xn/app/control/agents/real_wager_VB/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Bóng chuyền</a>
			<a onClick="go_web(0,1,'/xn/app/control/agents/real_wager_BS/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Bóng chày</a>
			<a onClick="go_web(0,1,'/xn/app/control/agents/voucher.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Lưu ý luồng</a>
			</nobr></td>
			...
			<a onClick="go_web(0,1,'/xn/app/control/agents/real_wager_FU/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Bữa sáng bóng đá</a>
			<a onClick="go_web(0,1,'/xn/app/control/agents/real_wager_BU/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Bữa sáng kiểu Mỹ / Bóng rổ</a>
			<a onClick="go_web(0,1,'/xn/app/control/agents/real_wager_BSFU/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Bữa sáng bóng chày</a>
			<a onClick="go_web(0,0,'/xn/app/control/agents/real_wager_TU/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Bữa sáng quần vợt</a>
			<a onClick="go_web(0,0,'/xn/app/control/agents/real_wager_VU/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Bữa sáng bóng chuyền</a>
			</nobr></td>
			...
			<a onClick="go_web(1,2,'/xn/app/control/agents/su_list.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Nhà phân phối</a>
			<a onClick="go_web(1,2,'/xn/app/control/agents/agents/su_agents.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Quyền</a>
			<a onClick="go_web(1,3,'/xn/app/control/agents/members/su_members.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Thành viên</a>
			<a onClick="go_web(1,4,'/xn/app/control/agents/su_subuser.php?uid=<?=$uid?>');" style="cursor:hand;"><img src="/images/control/tri.gif">Subaccount</a>
			
			</nobr></td<?=$GFLAG_E?>>
			<td nowrap><a href="/app/control/agents/report/report.php?uid=<?=$uid?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='Báo cáo'; return true;" onMouseOut="window.status='';return true;">&nbsp;[Báo cáo]</a></td>
			
			<<?=$GFLAG_S?>td nowrap><a href="/app/control/agents/other_set/show_result.php?uid=<?=$uid?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='Kết quả'; return true;" onMouseOut="window.status='';return true;">&nbsp;[Kết quả]</a></td<?=$GFLAG_E?>>
			...
			<td nowrap><a href="/app/control/agents/body_home.php?uid=<?=$uid?>&langx=<?=$langx?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='Thông báo'; return true;" onMouseOut="window.status='';return true;">&nbsp;[Thông báo]</a></td>
			</tr>
		  </table>
	  </td>
	</tr>
