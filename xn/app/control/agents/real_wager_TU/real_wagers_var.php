...
$mysql="SELECT m_league as m_league FROM `tennis` WHERE `m_start` > now( ) and `m_Date` ='$mDate' group by m_league";
$result = mysql_query( $mysql);
