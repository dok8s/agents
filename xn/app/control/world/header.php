...
$mysql="select Agname,ID,status from web_world where Oid='$uid'";
                    ...
                    <div name="MaxTag" id="header" src="/js/header.js" linkage="header">
                        ...
                        <div class="navbox">
                            <div class="nav">
                                ...
                                <li class="drop-menu-effect"><a href="/xn/app/control/world/body_home.php?uid=<?=$uid?>&langx=<?=$langx?>"
                                                            target="main" onMouseOver="window.status='Trang chủ'; return true;" onMouseOut="window.status='';return true;">
                                    <span>Trang chủ</span></a>
                                </li>
                                <li class="drop-menu-effect"><a href="/xn/app/control/world/announcement/get_an.php?uid=<?=$uid?>&langx=<?=$langx?>" target="main" onMouseOver="window.status='Nội dung thông báo'; return true;" onMouseOut="window.status='';return true;"><span>Nội dung thông báo</span></a>
                                </li>

                                <li class="drop-menu-effect"> <a href="/xn/app/control/world/other_set/show_result.php?uid=<?=$uid?>"
                                                             target="main" onMouseOver="window.status='Kết quả'; return true;" onMouseOut="window.status='';return true;"><span>Kết quả</span></a>
                                </li>
                                <li class="drop-menu-effect"> <a href="/xn/app/control/world/other_set/show_currency.php?uid=<?=$uid?>"
                                                             target="main" onMouseOver="window.status='Tiền tệ'; return true;" onMouseOut="window.status='';return true;"><span>Tiền tệ</span></a>
                                </li>
                                <li class="drop-menu-effect"> <a href="/xn/app/control/world/su_list.php?uid=<?=$uid?>" target="main" onMouseOver="window.status='Quản lý tài khoản'; return true;" onMouseOut="window.status='';return true;"><span>Quản lý tài khoản</span></a>
                                </li>

                                <li class="drop-menu-effect"> <a href="/xn/app/control/world/report/report.php?uid=<?=$uid?>"
                                                         target="main" onMouseOver="window.status='Báo cáo'; return true;" onMouseOut="window.status='';return true;"><span>Báo cáo</span></a>
                                </li>
                                <li class="drop-menu-effect"> <a href="/xn/app/control/world/scroll_history.php?uid=<?=$uid?>"
