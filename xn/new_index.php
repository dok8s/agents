...
<script language="JavaScript" type="text/JavaScript"> 
	var def_user = "Đăng nhập tài khoản";
	var def_passwd = "Mật khẩu";
	var def_passwd_safe = "Mã bảo mật";
	var info_user = "Vui lòng nhập tài khoản của bạn";
	var info_passwd = "Vui lòng nhập mật khẩu của bạn";
	var info_passwd_safe = "Vui lòng nhập mã bảo mật";
</script>
</head>
...
">Phiên bản cũ</div>
		...
		<div class="loginBOX">
			...
			<form id="LoginForm" name="LoginForm" method="post" action="" onSubmit="return chk_acc();">
				<input id="langx" type="hidden" name="langx" value=vi_VN>
				
				<div class="log_btnG">
					<span id="btn_A" onClick="checkF('A');" class="log_btnON">Đăng nhập 1</span>
					<span id="btn_B" onClick="checkF('B');" class="log_btn">Đăng nhập 2</span>
					<span id="btn_C" onClick="checkF('C');" class="log_btn">Đăng nhập 3</span>
				</div>
				<div class="login">
					<div class="account">
						<input id="username" class="input_box" type="text" name="username" value="" maxlength="26" tabindex="1" onFocus="inputFocus(this,def_user);" onBlur="inputBlur(this,def_user);" placeholder="Đăng nhập tài khoản">
					</div>
					<div class="password">
						<input id="passwd" class="input_box" type="password" name="passwd" value="" maxlength="28" tabindex="2" onFocus="inputFocus(this,def_passwd);" onBlur="inputBlur(this,def_passwd);" placeholder="Mật khẩu">
					</div>
					
					<div id="Sefe">
						<div class="notice">Không yêu cầu cài đặt mã bảo mật</div>
						<div class="safe">
							<input id="passwd_safe" class="input_box" type="password" name="passwd_safe" value="" maxlength="28" tabindex="2" onFocus="inputFocus(this,def_passwd_safe);" onBlur="inputBlur(this,def_passwd_safe);" placeholder="Mã bảo mật">
						</div>
					</div>
					
					<div id="hr_info" class="warn" style="display:none;">Vui lòng nhập tài khoản của bạn</div>
					<div class="remember">
						<label><input type="checkbox" id="remember"/><span></span></label>
						<span class="remember_word">Nhớ tài khoản của tôi</span>
					</div>
					<input class="send_btn" type="button" id="Forms Button1" onClick="chk_type();" value="Đăng nhập">
				</div>
			</form>
		</div>
	</div>
...
<body  onLoad="onload();">
	<div class="main">
		<div class="lang">
			...
			<a href="./new_index.php?langx=en-us"><span name="link_us" class="lan_word">English</span></a>
			<a href="./new_index.php?langx=vi_VN"><span name="link_us" class="lan_word">Người việt </span></a>
		</div>
