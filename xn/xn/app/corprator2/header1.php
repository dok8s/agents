...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<a onClick="go_web(0,1,'/xn/app/corprator/real_wager_BK/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Bóng rổ / Mizuo </a>
	...
	<a onClick="go_web(1,7,'/xn/xn/app/corprator/wager_list/wager_hide.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">Tài khoản ẩn</a>
	<? } ?>
	</nobr></td><?=$GFLAG_E?>>
	...
	<<?=$GFLAG_S?>td nowrap><a href="/xn/app/corprator/other_set/show_currency.php?uid=<?=$uid?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='Giá trị tiền tệ'; return true;" onMouseOut="window.status='';return true;">&nbsp;[Giá trị tiền tệ]</a></td>
	...
	<td nowrap><a href="/xn/app/corprator/body_home.php?uid=<?=$uid?>&langx=<?=$langx?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='Thông báo'; return true;" onMouseOut="window.status='';return true;">&nbsp;[Thông báo]</a></td>
	</tr>
	</table>
    </td>
  </tr>
