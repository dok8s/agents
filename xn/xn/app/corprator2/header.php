...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<a onClick="go_web(1,7,'/xn/xn/app/corprator/wager_list/wager_hide.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">隐单帐号</a>
	<? } ?>
	</nobr></td<?=$GFLAG_E?>>
