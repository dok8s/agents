...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td class="top_color" >3--<?=$agname?>--<?=$passwd_safe?>
					...
					<table border="0" cellspacing="0" cellpadding="0"  style="position: relative; z-index: 99; top: 0px; left: 0px;" id="toolbar1">
						<tr>
							...
							<td id=mo_list style="color: blue;"><nobr>
								<a onClick="go_web(1,2,'/xn/app/control/agents/ag_list.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">代理</a>
								<a onClick="go_web(1,3,'/xn/app/control/agents/members/ag_members.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">会员</a>
								<a onClick="go_web(1,4,'/xn/app/control/agents/ag_subuser.php?uid=<?=$uid?>');" style="cursor:hand;"><img src="/images/control/tri.gif">子帐号</a>
							</nobr></td<?=$CFLAG_E?>>
							<td nowrap><a href="/xn/app/control/agents/report/report.php?uid=<?=$uid?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='报表'; return true;" onMouseOut="window.status='';return true;">&nbsp;[报表]</a></td>
							...
							<<?=$CFLAG_S?>td nowrap><a href="/xn/app/control/agents/other_set/show_result.php?uid=<?=$uid?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='赛果'; return true;" onMouseOut="window.status='';return true;">&nbsp;[赛果]</a></td<?=$CFLAG_E?>>
							...
							<td nowrap><a href="/xn/app/control/agents/body_home.php?uid=<?=$uid?>&langx=<?=$langx?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='公告'; return true;" onMouseOut="window.status='';return true;">&nbsp;[公告]</a></td>
							<td nowrap></td>
						</tr>
					</table>
		</td>
