...
top.str_confirm_enable_priN = "是否确定\"禁止\"该";
</script>
<html>
<head>
<title>-代理商介面</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<tr>
			...
			<a onClick="go_web(0,0,'/xn/app/control/world/real_wager/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">足球</a>
			<a onClick="go_web(0,1,'/xn/app/control/world/real_wager_BK/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">篮球/美足</a>
			<a onClick="go_web(0,1,'/xn/app/control/world/real_wager_TN/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">网球</a>
			<a onClick="go_web(0,1,'/xn/app/control/world/real_wager_VB/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">排球</a>
			<a onClick="go_web(0,1,'/xn/app/control/world/real_wager_BS/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">棒球</a>
			<a onClick="go_web(0,1,'/xn/app/control/world/voucher.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">流水注单</a>
			</nobr></td>
			<td class="coolButton" onClick="show_webs('mad');" nowrap>&nbsp;<nobr>[早餐注单]</nobr>&nbsp;</td>
			<td nowrap id=mad_list style="color: blue;"><nobr>
			<a onClick="go_web(0,1,'/xn/app/control/world/real_wager_FU/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">足球早餐</a>
			<a onClick="go_web(0,1,'/xn/app/control/world/real_wager_BU/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">篮球/美足早餐</a>
			<a onClick="go_web(0,1,'/xn/app/control/world/real_wager_BSFU/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">棒球早餐</a>
			<a onClick="go_web(0,0,'/xn/app/control/world/real_wager_TU/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">网球早餐</a>
			<a onClick="go_web(0,0,'/xn/app/control/world/real_wager_VU/index.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">排球早餐</a>
			</nobr></td>
			
			<<?=$GFLAG_S?>td class="coolButton" onClick="show_webs('mo');" nowrap>&nbsp;<nobr>[帐号管理]</nobr>&nbsp;</td>
			<td nowrap id=mo_list style="color: blue;"><nobr>
			<a onClick="go_web(1,2,'/xn/app/control/world/su_list.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">总代理</a>
			<a onClick="go_web(1,2,'/xn/app/control/world/agents/su_agents.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">代理</a>
			<a onClick="go_web(1,3,'/xn/app/control/world/members/su_members.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">会员</a>
			<a onClick="go_web(1,4,'/xn/app/control/world/su_subuser.php?uid=<?=$uid?>');" style="cursor:hand;"><img src="/images/control/tri.gif">子帐号</a>
			
			</nobr></td<?=$GFLAG_E?>>
			<td nowrap><a href="/xn/app/control/world/report/report.php?uid=<?=$uid?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='报表'; return true;" onMouseOut="window.status='';return true;">&nbsp;[报表]</a></td>
			
			<<?=$GFLAG_S?>td nowrap><a href="/xn/app/control/world/other_set/show_result.php?uid=<?=$uid?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='赛果'; return true;" onMouseOut="window.status='';return true;">&nbsp;[赛果]</a></td<?=$GFLAG_E?>>
			...
			<td nowrap><a href="/xn/app/control/world/body_home.php?uid=<?=$uid?>&langx=<?=$langx?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='公告'; return true;" onMouseOut="window.status='';return true;">&nbsp;[公告]</a></td>
			</tr>
		  </table>
	  </td>
	</tr>
