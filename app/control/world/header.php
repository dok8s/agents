                    ...
                    <div name="MaxTag" id="header" src="/js/header.js" linkage="header">
                        ...
                        <div class="navbox">
                            <div class="nav">
                                ...
                                <li class="drop-menu-effect"><a href="/app/control/world/body_home.php?uid=<?=$uid?>&langx=<?=$langx?>"
                                                                target="main" onMouseOver="window.status='首页'; return true;" onMouseOut="window.status='';return true;">
                                        <span>首页</span></a>
                                </li>
                                <li class="drop-menu-effect"><a href="/app/control/world/announcement/get_an.php?uid=<?=$uid?>&langx=<?=$langx?>" target="main" onMouseOver="window.status='公告内容'; return true;" onMouseOut="window.status='';return true;"><span>公告内容</span></a>
                                </li>

                                <li class="drop-menu-effect"> <a href="/app/control/world/other_set/show_result.php?uid=<?=$uid?>"
                                                                 target="main" onMouseOver="window.status='赛果'; return true;" onMouseOut="window.status='';return true;"><span>赛果</span></a>
                                </li>
                                <li class="drop-menu-effect"> <a href="/app/control/world/other_set/show_currency.php?uid=<?=$uid?>"
                                                                 target="main" onMouseOver="window.status='币值'; return true;" onMouseOut="window.status='';return true;"><span>币值</span></a>
                                </li>
                                <li class="drop-menu-effect"> <a href="/app/control/world/su_list.php?uid=<?=$uid?>" target="main" onMouseOver="window.status='帐号管理'; return true;" onMouseOut="window.status='';return true;"><span>帐号管理</span></a>
                                </li>

                                <li class="drop-menu-effect"> <a href="/app/control/world/report/report.php?uid=<?=$uid?>"
                                                                 target="main" onMouseOver="window.status='报表'; return true;" onMouseOut="window.status='';return true;"><span>报表</span></a>
                                </li>
                                <li class="drop-menu-effect"> <a href="/app/control/world/scroll_history.php?uid=<?=$uid?>"
