...
<table width="880" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="" width="850">&nbsp;���ϲ��̣�
      	<input name=button type=button class="za_button" onClick="reload()" value="����"><font color="#cc0000">�������ѯ����:</font>
      	<select name="search" class="za_select">
            <option value="">��ָ��</option>
            <option value="2">�ɶ�</option>
            <option value="3">�ܴ���</option>
            <option value="4">������</option>
            <option value="5">��Ա</option>
            <option value="6">ע����</option>
            <option value="7">�ѽ���</option>
            <option value="8">Ͷעʱ��</option>
          </select>
          <input type="text" size=16 name="search_data" value="<?=$search_value?>">
					...
					<INPUT class=za_button type=submit value=��ѯ name=SUBMIT>
        	</td>
    </tr>
  </table>
</form><BR>
<table width="910" border="0" cellspacing="1" cellpadding="0" class="m_tab" bgcolor="#000000">
 <tr class="m_title_ft">
  <td width="70"align="center">Ͷעʱ��</td>
  <td width="100" align="center">��ˮ����</td>
  <td width="100" align="center">�û�����</td>
  <td width="100" align="center">��������</td>
  <td width="230" align="center">����</td>
  <td width="70" align="center">Ͷע</td>
  <td width="70" align="center">��Ӯ���</td>
